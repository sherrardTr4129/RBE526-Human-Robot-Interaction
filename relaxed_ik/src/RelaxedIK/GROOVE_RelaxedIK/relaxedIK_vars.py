...
from ..GROOVE.GROOVE_Utils.weight_function import Weight_Function, Identity_Weight, Dynamic_Weight
...
class RelaxedIK_vars(Vars):
    def __init__(self, name,
                 ...
                 objectives=(
                 Arm0_Look_At_Obj(), Arm0_High(), Roll_Limit(), Away_From_Head(), Dist_To_Target(), Min_Jt_Vel_Obj(),
                 Min_Jt_Accel_Obj(), Min_Jt_Jerk_Obj(), Joint_Limit_Obj(), Collision_Avoidance_nn(),
                 Position_MultiEE_Obj(), Orientation_MultiEE_Obj()),
                 ...
                 weight_funcs=(Dynamic_Weight(), Dynamic_Weight(), Dynamic_Weight(), Dynamic_Weight(), Dynamic_Weight(),
                               Dynamic_Weight(), Dynamic_Weight(), Dynamic_Weight(), Dynamic_Weight(),
                               Dynamic_Weight(), Dynamic_Weight(), Dynamic_Weight()),
                 # weight_priors=( 100.0 , 40.0, 100.0, 60.0, 30.0, 0.3, 0.3, 0.3, 1.0, 2.0),
                 weight_priors=(100.0, 40.0, 100.0, 60.0, 30.0, 0.3, 0.3, 0.3, 1.0, 2.0, 50.0, 40.0),
                 constraints=(),
                 bounds=(),
                 collision_file='',
        ...
        Vars.__init__(self, name, objective_function, init_state, objectives, weight_funcs, weight_priors, constraints,
                      bounds)
        # check inputs #####################################################################################################################
        ...
        Vars.__init__(self, name, objective_function, self.init_state, objectives, weight_funcs, weight_priors,
    ...
    def update(self, xopt, f_obj, publish_objectives=True, publish_constraints=True, publish_weight_funcs=True):
        Vars.update(self, xopt, f_obj, publish_objectives=publish_objectives, publish_constraints=publish_constraints,
